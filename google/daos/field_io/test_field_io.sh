...
if [ -z "$pool_id" ] ; then
	...
	echo "Cannot create pools in this system." && exit 1
...
if [ $pool_created -eq 1 ] ; then
	echo "Pools cannot be destroyed in this system" && exit 1
else
